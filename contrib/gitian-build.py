...
def build():
    ...
    subprocess.check_call(['wget', '-N', '-P', 'inputs', 'https://github.com/OmniLite/omnilite/raw/d3923522d1f05f0a02354ae8bf99b7045b7a0c89/contrib/osslsigncode-1.7.1.tar.gz'])

...
static bool getDisclaimerDialogResult()
{
    ...
    "By default this software will use your existing Litecoin wallet, including spending "
    "litecoins contained therein (for example for transaction fees or trading).\n\n"
    ...
    "EXPERIMENTAL. Your wallet data, litecoins and Omni Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of litecoins or Omni Layer "
